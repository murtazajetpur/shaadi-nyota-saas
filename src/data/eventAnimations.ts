...
export const eventAnimationOptions: EventAnimationOption[] = [
  ...
  },
  {
    ...
    recommendedFor: ['mehendi', 'wedding', 'reception', 'generic'],
    intensity: 'soft',
  ...
  },
  {
    ...
    recommendedFor: ['haldi', 'mehendi', 'wedding'],
    intensity: 'soft',
  ...
  },
  {
    ...
    recommendedFor: ['haldi', 'sangeet', 'wedding', 'reception'],
    intensity: 'soft',
  ...
  },
  {
    ...
    recommendedFor: ['haldi', 'mehendi', 'wedding', 'reception'],
    intensity: 'soft',
