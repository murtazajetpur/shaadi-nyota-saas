  ...
  sections: {
    openingReveal: {
      ...
      revealedImages: [
        ...
        baseAsset({
          id: 'revealed-generic-classic-05',
          label: 'Decorative Reveal V',
          src: '/assets/opening-reveal/envelope/revealed-images/revealed-generic-classic-05.png',
          type: 'image',
          section: 'openingReveal',
          category: 'revealed-image',
          style: 'classic',
        ...
        baseAsset({
          id: 'revealed-generic-classic-06',
          label: 'Decorative Reveal VI',
          src: '/assets/opening-reveal/envelope/revealed-images/revealed-generic-classic-06.png',
          type: 'image',
          section: 'openingReveal',
          category: 'revealed-image',
          style: 'classic',
    ...
    events: {
      ...
      generic: makeEventAssets('generic', [
        ...
        'event-generic-background-01',
        'event-generic-background-02',
